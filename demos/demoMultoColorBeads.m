...
load multiColor.mat
original = flipud(rot90(double(imread('multicolorbeads.tif') ) ) );
N = 256^2;

%% number of measurements
M = 8192 / 8; % for M = 512, 1024, 2048, 4096 or 8192, results are already in memory
